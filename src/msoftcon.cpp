...
void init_graphics()
{
    ...
    fill_char = '█';  //default fill is solid block
    clear_screen();
}
//--------------------------------------------------------------
...
void set_cursor_pos(int x, int y)
{
    ...
    cursor_pos.X = info.dwCursorPosition.X + x - 1;          //Windows starts at (0, 0)
    cursor_pos.Y = info.dwCursorPosition.Y + y - 1;          //we start at (1, 1)
